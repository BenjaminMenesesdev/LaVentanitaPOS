...
export const SEED_TODAY_SALES = [
  { id: "V-118421", time: minutesAgo(260), client: "", items: [{ name: "Vaso Simple (Vainilla)", price: 2500, qty: 2 }], method: "efectivo", total: 5000 },
  { id: "V-118422", time: minutesAgo(215), client: "", items: [{ name: "Cono Doble (Chocolate + Vainilla)", price: 3500, qty: 1 }, { name: "Chocolate Caliente", price: 3200, qty: 1 }], method: "debito", total: 6700 },
  { id: "V-118423", time: minutesAgo(140), client: "Mesa 2", items: [{ name: "Sundae (Manjar + Chocolate)", price: 4800, qty: 2 }], method: "credito", total: 9600 },
  { id: "V-118424", time: minutesAgo(75), client: "", items: [{ name: "Vaso Doble (Frutilla + Vainilla)", price: 3300, qty: 3 }], method: "efectivo", total: 9900 },
  { id: "V-118425", time: minutesAgo(20), client: "", items: [{ name: "Afogato", price: 3800, qty: 2 }, { name: "Barquillo Adicional", price: 300, qty: 2 }], method: "debito", total: 8200 },
];
